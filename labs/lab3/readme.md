...
In this lab, you will create and deploy an Ubuntu VM for hosting Docker containers.  You will install Docker, and a demo application will be deployed with Docker-compose.  These containers will be your first set of backend applications running in Azure, so you have something for Nginx for Azure to load balance.

Your completed Ubuntu VM deployment will look like this:
...
:---------------------:|:---------------------:|:---------------------:
![NGINX aaS](media/nginx-azure-icon.png) |![Ubuntu](media/ubuntu-icon.png) |![Docker](media/docker-icon.png)
